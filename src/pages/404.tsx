...
const PageNotFound404 = () => {
  ...
  return (
    <div className="h-screen min-h-full bg-page404 bg-cover bg-center bg-no-repeat px-4 py-16 text-gray_90 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
